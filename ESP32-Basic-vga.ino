...
// We can use a german keyboard layout instead of the US one
#define ENABLE_KEYBOARDLAYOUT_GERMAN
//#undef ENABLE_KEYBOARDLAYOUT_GERMAN
...
#ifdef ENABLE_KEYBOARDLAYOUT_GERMAN
